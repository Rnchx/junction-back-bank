...
export const getUsers = async (req, res) => {
  try {
    ...
    return res.status(500).send({
      message:
        "Erro ao buscar os dados dos usuarios:", error: error.message
    })
  }
};
...
export const getUserById = async (req, res) => {
  try {
    ...
    return res.status(500)
      .send({ message: "Erro ao buscar o usuario por ID:", error: error.message });
  }
};
...
export const createUser = async (req, res) => {
  try {
    ...
    return res.status(500)
      .send({
        message:
          "Erro no cadastro de um novo usuário: ", error: error.message
      });
  }
};
...
export const updateUser = async (req, res) => {
  try {
    ...
    return res.status(500)
      .send({
        message:
          "Erro na atualização do usuário:", error: error.message
      })
  }
};
...
export const deleteUser = async (req, res) => {
  try {
    ...
    res.status(500).send({ message: "Erro ao deletar o usuário", error: error.message });
  }
};
